...
この閾値では，小さい山でもピークと判断され，印が付けられていることがわかる．そのため，TOP\_THRESHOLDが300では適切でないことがわかる．
\begin{figure}[H]
    \centering
...
この閾値では，小さい山にもピークと判定され，印が付けられていることがわかる．そのため，TOP\_THRESHOLDが350では適切でないことがわかる．
\begin{figure}[H]
    \centering
...
図\ref{t_400_d_4}にて，DOWN\_THRESHOLDが4では，閾値設定が大きいことが確認できた．そのため，４未満の数値で検討を行う．
...
32行目では返り値として時間を返すようにされている．また，返り値が時間であるため，top関数の型のサイズも32ビットに変更している．
